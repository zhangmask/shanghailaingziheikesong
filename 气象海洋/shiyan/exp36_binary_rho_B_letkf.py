...
OUTPUT_DIR = ROOT / "exp36_binary_rho_B_outputs"
REMOTE_BASE = Path("/home/infra/qda_competition")
REMOTE_OUTPUT = REMOTE_BASE / "experiments" / "binary_rho_B_letkf"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="实验36：rho-B 二元弱融合 LETKF 验证")
...
def build_experiments() -> list[tuple[str, float | None, float | None]]:
    ...
    for lam_rho, lam_b in LAMBDA_COMBOS:
        experiments.append(("binary_rho_b", lam_rho, lam_b))
    return experiments
