...
| 误差度量 | Trace-Squared-Deviation | RMSE的量子版本 |
...
3. **Robust statistical methods** - 鲁棒统计方法
...
**似然函数**:
$$p(y|\theta) = \sin^2(m\theta + \phi)$$

**自适应采样**:
$$m_{k+1} = \arg\max_m \text{Expected Information Gain}(m)$$
